document.addEventListener('DOMContentLoaded', () => {
    if (window.location.hostname === 'focp.droppages.com'){
        shutdownMessage();
    }
});
...
function shutdownMessage(){
    ...
    el.innerHTML = `
        <div style="font-size: large; padding-top: 0.3em; ">
            <p style="color: coral;">! ATTENTION !</p>
            <p>From January 1st, 2026, the DropPages site will be shut down</p>
            <p>You can use the mirror <a href="https://m208.github.io/focp/" target="_blank">m208.github.io/focp/</a></p>
        </div>
    `;
}
